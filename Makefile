...
# Generated by qmake (2.01a) (Qt 4.8.7) on: mar. mars 27 15:42:37 2018
# Project:  main.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Projet1.0.0/ && $(COPY_FILE) --parents shader.h meshLoader.h trackball.h camera.h viewer.h .tmp/Projet1.0.0/ && $(COPY_FILE) --parents shader.cpp meshLoader.cpp trackball.cpp camera.cpp main.cpp viewer.cpp .tmp/Projet1.0.0/ && (cd `dirname .tmp/Projet1.0.0` && $(TAR) Projet1.0.0.tar Projet1.0.0 && $(COMPRESS) Projet1.0.0.tar) && $(MOVE) `dirname .tmp/Projet1.0.0`/Projet1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Projet1.0.0
